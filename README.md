...
- permets de voir les sessions de cours à venir
- permets d'afficher les inscriptions en cours
- permets de voir les paiements effectués ou dûs
- permets aux enseignants afin d'accéder aux méthodes de gestion des inscriptions
- permets aux enseignants de générer une liste des étudiants par cours, une liste des étudiants inscrits FFSU et de saisir des notes
