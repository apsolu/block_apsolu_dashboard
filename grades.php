...
require_once($CFG->dirroot.'/blocks/apsolu_dashboard/locallib.php');
require_once($CFG->dirroot.'/blocks/apsolu_dashboard/grades_courses_form.php');

$courseid = optional_param('courseid', null, PARAM_INT);

$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('admin');
$PAGE->set_url('/blocks/apsolu_dashboard/grades.php');
$PAGE->set_title(get_string('my_graded_students', 'block_apsolu_dashboard'));

// Navigation.
$PAGE->navbar->add(get_string('my_graded_students', 'block_apsolu_dashboard'));

$PAGE->requires->js_call_amd('block_apsolu_dashboard/grades', 'initialise');
...
$coursesmform = new block_apsolu_dashboard_courses_form(null, $customdata);
...
if ($courseid) {
    ...
    foreach ($data->periods as $index => $period) {
        ...
        $period->action = $CFG->wwwroot.'/blocks/apsolu_dashboard/grades.php';
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('my_students', 'block_apsolu_dashboard'));
$coursesmform->display();
if ($courseid) {
    echo $OUTPUT->render_from_template('block_apsolu_dashboard/grades', $data);
}
echo $OUTPUT->footer();
