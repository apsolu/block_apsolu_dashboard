...
require_once($CFG->dirroot.'/blocks/apsolu_dashboard/ffsu_form.php');
require_once($CFG->libdir.'/excellib.class.php');

$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('admin');
$PAGE->set_url('/blocks/apsolu_dashboard/ffsu.php');
$PAGE->set_title(get_string('my_students', 'block_apsolu_dashboard'));
...
$mform = new block_apsolu_dashboard_federation_export_form(null, $customdata);
...
if ($data = $mform->get_data()) {
    ...
    if ($data->submitbutton === get_string('show')) {
        ...
        $data->found_users = get_string('found_students', 'local_apsolu', $data->count_users);
        ...
        $mform->display();
        echo $OUTPUT->render_from_template('block_apsolu_dashboard/ffsu', $data);
        echo $OUTPUT->footer();
        ...
        $headers[] = get_string('medical_certificate', 'local_apsolu');
        $headers[] = get_string('federation_paid', 'local_apsolu');
