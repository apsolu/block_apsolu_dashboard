...
$string['pay'] = 'Payer';
$string['from_date_to_date_with_enrolment_role'] = 'Du <strong>{$a->startcourse}</strong> au <strong>{$a->endcourse}</strong> en inscription <span class="font-weight-bold">{$a->role}</span>.';
$string['from_date_to_date_with_enrolment_role_and_status'] = 'Du <strong>{$a->startcourse}</strong> au <strong>{$a->endcourse}</strong> en inscription <span class="font-weight-bold">{$a->role}</span> (<em class="text-danger">{$a->status}</em>).';
